...
trước khi tới ta, còn bơm hộ ở host thì winlogon không nhận input tổng hợp cho
các tổ hợp nó canh giữ (đã thử qua nút gửi hộ 24/07/2026 — bỏ). Cần Task Manager
ở host thì người ở host tự mở, hoặc client mở Start menu từ xa mà gõ.
