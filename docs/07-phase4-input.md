...
từ ngoài → test được offline (`--nettest`).
...
`--nettest` kiểm chứng đúng tính chất này: **bỏ 1/3 số datagram, mọi event vẫn được
...
đổi ngược theo **client rect của cửa sổ đích tại thời điểm nhận**.
...
|-----|----------|-----------|
| M1 | `--nettest`: wire roundtrip, khử trùng khi mất 1/3 gói, chống đảo thứ tự | ✅ PASS |
